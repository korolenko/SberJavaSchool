...
public class CoreUtils {
    ...
    public void createDevice(int id){
        ...
        for(int i = 0; i<componentsNumber; i++){
            ...
            Component component = new Component(i+1,componentName,componentStatus);
    ...
    public Device showDevice(int id){
        return this.deviceList.get(id-1);
    }
        ...
        for (int i = 0; i<20; i++){
            ...
            switch (check){
                case (0):{
                    ...
                    System.out.println("error, deviceid: " + deviceId + ", " +
                            "componentid: " + componentId + ", componentsNumber:" + componentsNumber);
                    break;
                }
                case (1):
                {
                    ...
                    System.out.println("restore, deviceid: " + deviceId + ", " +
                            "componentid: " + componentId + ", componentsNumber:" + componentsNumber);
                    break;
                }
            }
